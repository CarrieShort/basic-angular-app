describe('angular app', () => {
  ...
  it('should not update on cancel', () => {
    ...
    element(by.css('.politicians ul')).element(by.model('politician.name')).clear().sendKeys('A different guy');
    element(by.css('.politicians ul')).element(by.model('politician.party')).clear().sendKeys('mice');
    element(by.css('.politicians ul')).element(by.model('politician.specialPower')).clear().sendKeys('things');
    element(by.css('.politicians ul')).element(by.model('politician.debateSkills')).clear().sendKeys('3');
